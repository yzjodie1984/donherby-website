    ...
    <main className="w-full min-h-screen">
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="relative h-[400px] rounded-2xl overflow-hidden shadow-[0_20px_40px_-10px_rgba(0,0,0,0.15)] group border border-slate-200">
              <img src="/images/img_155f681be9.jpg" alt="Team Synergy" className="absolute inset-0 w-full h-full object-cover grayscale opacity-90 transition-transform duration-700 group-hover:scale-[1.03]" referrerPolicy="no-referrer" />
      ...
      <section className="py-32 bg-slate-50 text-[var(--color-navy)] relative overflow-hidden">
         ...
         <div className="absolute inset-0 z-0 flex items-center justify-center pointer-events-none">
            <img src="/images/img_8da8d41969.jpg" alt="Global Network" className="w-full h-full object-cover opacity-[0.05] mix-blend-multiply" referrerPolicy="no-referrer" />
