...
export default function Home() {
  ...
  const serviceCards = [
    { icon: Ship, title: t('home.services.ocean.title'), sub: t('home.services.ocean.sub'), desc: t('home.services.ocean.desc'), img: 'https://images.unsplash.com/photo-1494412519320-aa613dfb7738?auto=format&fit=crop&w=800&q=80&fm=webp' },
    { icon: PlaneTakeoff, title: t('home.services.air.title'), sub: t('home.services.air.sub'), desc: t('home.services.air.desc'), img: 'https://images.unsplash.com/photo-1542296332-2e4473faf563?auto=format&fit=crop&w=800&q=80&fm=webp' },
    ...
    { icon: ShieldCheck, title: t('home.services.customs.title'), sub: t('home.services.customs.sub'), desc: t('home.services.customs.desc'), img: 'https://images.unsplash.com/photo-1454165804606-c3d57bc86b40?auto=format&fit=crop&w=800&q=80&fm=webp' }
  ];
    ...
    <main className="w-full">
      ...
      <section className="relative pt-32 pb-20 lg:pt-48 lg:pb-32 overflow-hidden bg-[var(--color-navy)] text-white">
        ...
        <div className="absolute inset-0 z-0">
          <img 
            src="https://images.unsplash.com/photo-1436491865332-7a61a109cc05?q=80&w=2674&auto=format&fit=crop&fm=webp" 
      ...
      <section id="market-presence" className="py-24 bg-[var(--color-navy)] text-white overflow-hidden relative">
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8 relative z-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 md:grid-rows-2 gap-4 auto-rows-[300px] h-auto md:h-[600px]">
            ...
            {/* Box 3 (Small - 8%) */}
            <div className="md:col-span-1 md:row-span-1 relative overflow-hidden rounded-2xl group border border-white/5 shadow-sm hover:shadow-[0_20px_40px_-10px_rgba(0,0,0,0.3)] hover:-translate-y-1.5 transition-all duration-300 cursor-default">
              <img src="https://upload.wikimedia.org/wikipedia/commons/thumb/9/90/Port_of_Singapore.jpg/1280px-Port_of_Singapore.jpg" alt="Port of Singapore" className="absolute inset-0 w-full h-full object-cover transition-transform duration-700 group-hover:scale-[1.03]" referrerPolicy="no-referrer" />
              <div className="absolute inset-0 bg-gradient-to-t from-[var(--color-navy)] via-[#0F172A]/80 to-[var(--color-navy)]/40 mix-blend-multiply"></div>
              <div className="absolute inset-0 bg-gradient-to-t from-[var(--color-navy)] via-transparent to-transparent"></div>
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8 relative z-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 md:grid-rows-2 gap-4 h-auto md:h-[600px] lg:h-[700px]">
             ...
             <div className="md:col-span-2 md:row-span-2 relative overflow-hidden rounded-2xl group min-h-[300px] shadow-sm hover:shadow-[0_20px_40px_-10px_rgba(0,0,0,0.4)] hover:-translate-y-1.5 transition-all duration-300 cursor-default">
                <img src="https://images.unsplash.com/photo-1581091226825-a6a2a5aee158?auto=format&fit=crop&q=80&w=1200&fm=webp" alt="Industrial and Energy" className="absolute inset-0 w-full h-full object-cover transition-transform duration-700 group-hover:scale-[1.03]" referrerPolicy="no-referrer" />
             ...
             <div className="md:col-span-1 md:row-span-1 relative overflow-hidden rounded-2xl group min-h-[250px] shadow-sm hover:shadow-[0_20px_40px_-10px_rgba(0,0,0,0.4)] hover:-translate-y-1.5 transition-all duration-300 cursor-default">
                <img src="https://images.unsplash.com/photo-1605810230434-7631ac76ec81?auto=format&fit=crop&q=80&w=800&fm=webp" alt="Complex Compliance" className="absolute inset-0 w-full h-full object-cover transition-transform duration-700 group-hover:scale-[1.03]" referrerPolicy="no-referrer" />
                <div className="absolute inset-0 bg-gradient-to-t from-[var(--color-navy)] via-[var(--color-navy)]/50 to-transparent"></div>
             ...
             <div className="md:col-span-1 md:row-span-1 relative overflow-hidden rounded-2xl group min-h-[250px] shadow-sm hover:shadow-[0_20px_40px_-10px_rgba(0,0,0,0.4)] hover:-translate-y-1.5 transition-all duration-300 cursor-default">
                <img src="https://images.unsplash.com/photo-1554520735-0a6b8b6ce8b7?auto=format&fit=crop&q=80&w=800&fm=webp" alt="Temperature Controlled" className="absolute inset-0 w-full h-full object-cover transition-transform duration-700 group-hover:scale-[1.03]" referrerPolicy="no-referrer" />
                <div className="absolute inset-0 bg-gradient-to-t from-[var(--color-navy)] via-[var(--color-navy)]/50 to-transparent"></div>
                <div className="absolute bottom-4 left-4 right-4 bg-white/10 backdrop-blur-md border border-white/20 p-4 rounded-xl transition-all duration-300 group-hover:bg-white/15">
                   <div className="flex flex-col mb-2 items-start gap-2">
             ...
             <div className="md:col-span-1 md:row-span-1 relative overflow-hidden rounded-2xl group min-h-[250px] shadow-sm hover:shadow-[0_20px_40px_-10px_rgba(0,0,0,0.4)] hover:-translate-y-1.5 transition-all duration-300 cursor-default">
                <img src="https://images.unsplash.com/photo-1616486338812-3dadae4b4ace?auto=format&fit=crop&q=80&w=800&fm=webp" alt="Fragile and High Value" className="absolute inset-0 w-full h-full object-cover transition-transform duration-700 group-hover:scale-[1.03]" referrerPolicy="no-referrer" />
                <div className="absolute inset-0 bg-gradient-to-t from-[var(--color-navy)] via-[var(--color-navy)]/50 to-transparent"></div>
                <div className="absolute bottom-4 left-4 right-4 bg-white/10 backdrop-blur-md border border-white/20 p-4 rounded-xl transition-all duration-300 group-hover:bg-white/15">
                   <div className="flex flex-col mb-2 items-start gap-2">
