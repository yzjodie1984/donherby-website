...
export default function Home() {
  ...
  const serviceCards = [
    { icon: Ship, title: t('home.services.ocean.title'), sub: t('home.services.ocean.sub'), desc: t('home.services.ocean.desc'), img: '/images/img_886c705aa1.webp' },
    { icon: PlaneTakeoff, title: t('home.services.air.title'), sub: t('home.services.air.sub'), desc: t('home.services.air.desc'), img: '/images/img_9d88eaaa2e.webp' },
    { icon: Train, title: t('home.services.rail.title'), sub: t('home.services.rail.sub'), desc: t('home.services.rail.desc'), img: '/images/img_30671c7789.webp' },
    { icon: Route, title: t('home.services.hybrid.title'), sub: t('home.services.hybrid.sub'), desc: t('home.services.hybrid.desc'), img: '/images/img_c0b5e42c4f.webp' },
    { icon: Warehouse, title: t('home.services.warehouse.title'), sub: t('home.services.warehouse.sub'), desc: t('home.services.warehouse.desc'), img: '/images/img_6a6d645457.webp' },
    { icon: ShieldCheck, title: t('home.services.customs.title'), sub: t('home.services.customs.sub'), desc: t('home.services.customs.desc'), img: '/images/img_ddc829e850.webp' }
  ];
    ...
    <main className="w-full">
      ...
      <section className="relative pt-32 pb-20 lg:pt-48 lg:pb-32 overflow-hidden bg-[var(--color-navy)] text-white">
        ...
        <div className="absolute inset-0 z-0">
          <img 
            src="/images/img_edbd1534ba.webp" 
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8 relative z-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 md:grid-rows-2 gap-4 auto-rows-[300px] h-auto md:h-[600px]">
            ...
            <div className="md:col-span-2 md:row-span-2 relative overflow-hidden rounded-2xl group border border-white/5 shadow-sm hover:shadow-[0_20px_40px_-10px_rgba(0,0,0,0.3)] hover:-translate-y-1.5 transition-all duration-300 cursor-default">
              <img src="/images/img_f98528396b.webp" alt="Port of Hamburg" className="absolute inset-0 w-full h-full object-cover transition-transform duration-700 group-hover:scale-[1.03]" referrerPolicy="no-referrer" />
            ...
            <div className="md:col-span-1 md:row-span-1 relative overflow-hidden rounded-2xl group border border-white/5 shadow-sm hover:shadow-[0_20px_40px_-10px_rgba(0,0,0,0.3)] hover:-translate-y-1.5 transition-all duration-300 cursor-default">
              <img src="/images/img_10fb11f8c5.webp" alt="Port of Busan" className="absolute inset-0 w-full h-full object-cover transition-transform duration-700 group-hover:scale-[1.03]" referrerPolicy="no-referrer" />
            ...
            {/* Box 3 (Small - 8%) */}
            <div className="md:col-span-1 md:row-span-1 relative overflow-hidden rounded-2xl group border border-white/5 shadow-sm hover:shadow-[0_20px_40px_-10px_rgba(0,0,0,0.3)] hover:-translate-y-1.5 transition-all duration-300 cursor-default">
              <img src="/images/img_6ead68f5de.webp" alt="Port of Singapore" className="absolute inset-0 w-full h-full object-cover transition-transform duration-700 group-hover:scale-[1.03]" referrerPolicy="no-referrer" />
              <div className="absolute inset-0 bg-gradient-to-t from-[var(--color-navy)] via-[#0F172A]/80 to-[var(--color-navy)]/40 mix-blend-multiply"></div>
              <div className="absolute inset-0 bg-gradient-to-t from-[var(--color-navy)] via-transparent to-transparent"></div>
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8 relative z-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 md:grid-rows-2 gap-4 h-auto md:h-[600px] lg:h-[700px]">
             ...
             <div className="md:col-span-2 md:row-span-2 relative overflow-hidden rounded-2xl group min-h-[300px] shadow-sm hover:shadow-[0_20px_40px_-10px_rgba(0,0,0,0.4)] hover:-translate-y-1.5 transition-all duration-300 cursor-default">
                <img src="/images/img_41d8153b9f.webp" alt="Industrial and Energy" className="absolute inset-0 w-full h-full object-cover transition-transform duration-700 group-hover:scale-[1.03]" referrerPolicy="no-referrer" />
             ...
             <div className="md:col-span-1 md:row-span-1 relative overflow-hidden rounded-2xl group min-h-[250px] shadow-sm hover:shadow-[0_20px_40px_-10px_rgba(0,0,0,0.4)] hover:-translate-y-1.5 transition-all duration-300 cursor-default">
                <img src="/images/img_d2ee6edf3b.webp" alt="Complex Compliance" className="absolute inset-0 w-full h-full object-cover transition-transform duration-700 group-hover:scale-[1.03]" referrerPolicy="no-referrer" />
                <div className="absolute inset-0 bg-gradient-to-t from-[var(--color-navy)] via-[var(--color-navy)]/50 to-transparent"></div>
             ...
             <div className="md:col-span-1 md:row-span-1 relative overflow-hidden rounded-2xl group min-h-[250px] shadow-sm hover:shadow-[0_20px_40px_-10px_rgba(0,0,0,0.4)] hover:-translate-y-1.5 transition-all duration-300 cursor-default">
                <img src="/images/img_ff19877406.webp" alt="Temperature Controlled" className="absolute inset-0 w-full h-full object-cover transition-transform duration-700 group-hover:scale-[1.03]" referrerPolicy="no-referrer" />
                <div className="absolute inset-0 bg-gradient-to-t from-[var(--color-navy)] via-[var(--color-navy)]/50 to-transparent"></div>
                <div className="absolute bottom-4 left-4 right-4 bg-white/10 backdrop-blur-md border border-white/20 p-4 rounded-xl transition-all duration-300 group-hover:bg-white/15">
                   <div className="flex flex-col mb-2 items-start gap-2">
             ...
             <div className="md:col-span-1 md:row-span-1 relative overflow-hidden rounded-2xl group min-h-[250px] shadow-sm hover:shadow-[0_20px_40px_-10px_rgba(0,0,0,0.4)] hover:-translate-y-1.5 transition-all duration-300 cursor-default">
                <img src="/images/img_caf3a8acf1.webp" alt="Fragile and High Value" className="absolute inset-0 w-full h-full object-cover transition-transform duration-700 group-hover:scale-[1.03]" referrerPolicy="no-referrer" />
                <div className="absolute inset-0 bg-gradient-to-t from-[var(--color-navy)] via-[var(--color-navy)]/50 to-transparent"></div>
                <div className="absolute bottom-4 left-4 right-4 bg-white/10 backdrop-blur-md border border-white/20 p-4 rounded-xl transition-all duration-300 group-hover:bg-white/15">
                   <div className="flex flex-col mb-2 items-start gap-2">
             ...
             {/* 5. E-commerce & Retail */}
             <div className="md:col-span-1 md:row-span-1 relative overflow-hidden rounded-2xl group min-h-[250px] shadow-sm hover:shadow-[0_20px_40px_-10px_rgba(0,0,0,0.4)] hover:-translate-y-1.5 transition-all duration-300 cursor-default">
                <img src="/images/img_2440ab2c8a.webp" alt="E-commerce and Retail" className="absolute inset-0 w-full h-full object-cover transition-transform duration-700 group-hover:scale-[1.03]" referrerPolicy="no-referrer" />
                <div className="absolute inset-0 bg-gradient-to-t from-[var(--color-navy)] via-[var(--color-navy)]/50 to-transparent"></div>
                <div className="absolute bottom-4 left-4 right-4 bg-white/10 backdrop-blur-md border border-white/20 p-4 rounded-xl transition-all duration-300 group-hover:bg-white/15">
                   <div className="flex flex-col mb-2 items-start gap-2">
